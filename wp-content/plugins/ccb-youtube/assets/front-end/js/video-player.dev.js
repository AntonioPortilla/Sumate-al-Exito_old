...
;(function($){
	...
	$.fn.CCB_VideoPlayer = function(options){
		...
		var getFlashPlayerUrl = function(){			
			var v = playerParams();			
			return 'http://www.youtube.com/v/' + options.video_id + '?version=3&rel='+v.rel;
		}
...
;(function($){
	$(document).ready(function(){
		...
		//*/
		$('div.ccb_single_video_player').CCB_VideoPlayer({'elem_data' : true});		
	})
})(jQuery);
